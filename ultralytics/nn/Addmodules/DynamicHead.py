...
__all__ = ['DynamicHead', 'DynamicPose']
...
class DyConv(nn.Module):
    def __init__(self, in_channels=1024, out_channels=1024, conv_func=Conv3x3Norm):
...
class DynamicPose(DynamicHead):
    ...
    def __init__(self, nc=80, kpt_shape=(17, 3), ch=()):
        ...
        self.detect = DynamicHead.forward
